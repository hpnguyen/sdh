...
<img src="http://www.grad.hcmut.edu.vn/html2pdf/examples/res/logo.gif" alt="logo" style="width: XXXmm"><br>
B Test overflow<br>B Test overflow<br>B Test overflow<br>
<img src="../../html2pdf/examples/res/logo.gif" alt="logo" style="width: XXXmm"><br>
...
<page style="font-size: 10pt">
    <span style="font-size: 16pt ; font-weight: bold">Démonstration des images Thôi rồi lợm ơi</span><br>
    <br>
    ...
    <table style="width: 50%;border: solid 3px #5544DD" align="center">
        <tr>
            ...
            <td style="width: 40%; text-align: center;"><img src="../../html2pdf/examples/res/logo.gif" alt="" ><br><i>légende</i></td>
    ...
    texte à la suite d'une image, <img src="../../html2pdf/examples/res/logo.gif" alt="" style="height: 10mm">
