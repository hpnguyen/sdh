			...
			<table class='borderDOT' style='width:100%;' class=fontcontent cellpadding="5" cellspacing="0" border=1>
				...
				<tr class='borderDOT'>
					<td>
						...
						<div align=left>Số tài khoản: <?php echo $cbgd["SO_TAI_KHOAN"][0]; ?> Tại ngân hàng: <?php echo $cbgd["NGAN_HANG_MO_TK"][0]; ?></div>
					</td>
				</tr>
			</table>
		...
		<table class='bordertable fontcontent' style="width:100%" border=1 cellpadding=5>
			<thead>
				<tr class='bordertable'>
					<th rowspan=2 align=center>TT</th><th rowspan=2 align=center>Nội dung đánh giá</th><th colspan=3 align=center>Điểm tối đa</th><th rowspan=2 style="/*Quan trọng 110px->*/ width: 110px;" >Điểm đánh giá</th>
				</tr>
				<tr class='bordertable'>
					<th align=center >NCCB</th><th align=center>NCƯD</th><th align=center>NCTK</th>
				</tr>
			</thead>
			<tbody>
				<?php 	
				...
				for ($i = 0; $i < $n; $i++)
				{
					...
					<tr>
						...
						<td align=center>{$resDM["THANG_DIEM_C_NCTK"][$i]}</td>
						$td_diem
					</tr>";
					if ($numrowspan>0){	$numrowspan--;}
					
					$tongdiem += $resDM["DIEM"][$i];
				}
				$tmp.="
					<tr class='bordertable' style='font-weight:bold'>
