...
<div id="khcn_thuyetminhdtkhcn" style="width:100%;">
	<div style="width: 100%; margin: 10px 0 0 0;" align=center>
		<button id='khcn_reg_button' title="Bấm vào đây để đăng ký thuyết minh đề tài mới">Đăng ký thuyết minh Đề tài Khoa học & Công nghệ</button>
	</div>
	<div style="width: 100%; margin: 10px 0 0 0;" align=center>
		<button id='khcn_edit_ttchung_button' title="Bấm vào đây để cập nhật phần thông tin chung">A. Thông tin chung</button> <button id='khcn_edit_mota_button' title="Bấm vào đây để cập nhật phần mô tả nghiên cứu">B. Mô tả nghiên cứu</button>
	</div>
