...
if ($a=='editnhanlucnc'){
	...
	$hotensv = str_replace("'", "''", $_POST["khcn_ql_frm_reg_nhanlucnghiencuu_ho_ten_sv"]);
	...
	$manl = str_replace("'", "''", $_POST["khcn_ql_frm_reg_nhanlucnghiencuu_manl"]);
	...
	if ($n){
		...
		$data.= '
				"info":{
					...
					"tinhtrang":"'.escapeJsonString($resDM["FK_TINH_TRANG"][0]).'",
