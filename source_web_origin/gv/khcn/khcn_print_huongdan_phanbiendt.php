...
{
?>
<a id="khcn_print_hd_pbdt_btn_printpreview">&nbsp;In ...</a>
...
?>
    <table width="100%"   cellspacing="0" cellpadding="0" class="ui-corner-all shawdow tableData" >
	  ...
	  <tr>
		...
		<div align="center"  style="margin-top:20px; margin-bottom:20px"><b><font style="font-size:160%; font-weight:bold;">HƯỚNG DẪN PHẢN BIỆN ĐỀ TÀI</font></b><br/><font color=red>(Dùng trình duyệt <b>Mozilla Firefox</b> là tốt nhất)</font></div>
        </td>
      </tr>
      <tr>
        <td colspan=2>
...
$(function(){
 ...
 $( "#khcn_print_hd_pbdt_btn_printpreview" ).button({ icons: {primary:'ui-icon ui-icon-print'} });
 $( "#khcn_print_hd_pbdt_btn_printpreview" ).click(function(){
