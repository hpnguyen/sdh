      ...
      <tr>
        <td valign='top'> 
			<div align="left" style="margin-top:10px">
				<div align=left style="margin:10px 0px 0px 10px;" class=fontcontent>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ĐẠI HỌC QUỐC GIA TP.HCM<br>&nbsp;&nbsp;&nbsp;<b>TRƯỜNG ĐẠI HỌC BÁCH KHOA</b></div>
			</div>
        </td>
		<td valign='top'> 
			<div align="right"  style="margin-top:10px">
				<table class='borderDOT' style='font-size: 12px;' border=1>
					<tr><td class='borderDOT' ><b>Mã số đề tài</b></td><td class='borderDOT' style='width: 100px'><span id=khcn_print_r01_masodt<?php echo $key;?> ></span></td></tr>
				</table>
			</div>
        </td>
      </tr>
      ...
      <tr>
        <td colspan=2>
			...
			<table id=khcn_print_r01_table_content<?php echo $key; ?> width="100%" style="margin-top:10px" border="0" align="center" cellpadding="5" cellspacing="0" class="fontcontent">
						...
						<table id=khcn_print_r01_A9_table_nhanluc<?php echo $key; ?> cellspacing="0" cellpadding="5" border=1 class="fontcontent bordertable" border=1 style='width:100%'>
							<thead>
								<tr style='height:20px;font-weight:bold'>
									<td align=center>TT</td><td align=left>Học hàm, học vị, Họ và tên</td><td align=left>SHCC/MSSV</td><td align=left>Đơn vị công tác</td><td align=center title="Số tháng làm việc quy đổi">Số thàng làm việc quy đổi</td>
								</tr>
							</thead>
							<thead>
				...
				<tr align="left">
					<td align=left><b><?php echo "B".$z++."."; ?></b></td><td><b>Tổng hợp kinh phí đề nghị Trường cấp</b></td>
				</tr>
				<tr align="left">
					<td align=left></td>
					<td align=left>
						...
						<table id=khcn_print_r01_B8_table_khoanchiphi<?php echo $key; ?> cellspacing="0" cellpadding="5" border=1 class="fontcontent bordertable" border=1 style='width:100%'>
							<thead>
								<tr style='height:20px; font-weight: bold'>
									<td align=center rowspan=2>TT</td><td align=left  rowspan=2 style=''>Các khoản chi phí</td><td align=center colspan=3>Đề nghị Trường cấp</td>
								</tr>
...
$(function(){
 ...
 xreq = $.ajax({
   ...
   success: function(data) {
		if (data.success){
			var nhomnganh = '', kinhphi='', chunhiem='', chutri='', strtmp;
			...
			if (data.info.tom_tat_hd_nc != ''){
				...
				$("#khcn_print_r01_table_content<?php echo $key; ?> .tr_tom_tat_nc_dt_sdh<?php echo $key; ?>").remove();
			}
