...
<script src="../js/ui/minified/jquery.ui.menu.min.js"></script>
...
<body style="font-family:Arial, Helvetica, sans-serif; font-size:70%">
					...
					if ($khoa_tmp != $resDM["TEN_KHOA"][$i])
					{
						...
						echo "
							<li>
								...
								<ul>
									<li><a href='#' onClick='getDSGV(\"{$resDM["MA_BO_MON"][$i]}\");'>{$resDM["TEN_BO_MON"][$i]}</a></li>";
					}
					else
					{
						echo "		<li ><a href='#' onClick='getDSGV(\"{$resDM["MA_BO_MON"][$i]}\");'>{$resDM["TEN_BO_MON"][$i]}</a></li>";
					}
	...
	<div id="gv_index_dialog_msgbox" title="Phòng Đào Tạo SDH - ĐHBK TP.HCM: Thông tin khoa học">
