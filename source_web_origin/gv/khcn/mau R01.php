      ...
      <tr>
        <td valign='top'> 
			<div align="left" style="margin-top:10px">
				<img src="http://www.grad.hcmut.edu.vn/gvbeta/images/llkh/logodhqg.png" alt="" style="float:left; margin:-5px 5px 0px 5px;" width="72" height="53">
		...
		<td valign='top'> 
			<div align="center"  style="margin-top:10px">
				<table class='borderDOT' style='font-size: 12px;' border=1>
					<tr><td class='borderDOT' >Ngày nhận hồ sơ</td><td class='borderDOT' > 65</td></tr>
					<tr><td class='borderDOT' >Mã số đề tài</td><td class='borderDOT' ></td></tr>
				</table>
			</div>
        </td>
      </tr>
      ...
      <tr>
        <td colspan=2>
			...
			<table width="100%" style="margin-top:10px" border="0" align="center" cellpadding="5" cellspacing="0" class="fontcontent">
				...
				<tr align="left">        
					<td align=left ></td><td  style="">- Tên tiếng Việt: </td>
				</tr>
				<tr align="left">        
					<td align=left ></td><td  style="">- Tên tiếng Anh: </td>
				</tr>
				<tr align="left">
					<td align=left><b><?php echo "A".$z++."."; ?></b></td><td><b>Thuộc ngành/nhóm ngành</b></td>
				</tr>
				<tr align="left">
					<td align=left><b><?php echo "A".$z++."."; ?></b></td><td><b>Loại hình nghiên cứu</b></td>
				</tr>
				<tr align="left">
					<td align=left><b><?php echo "A".$z++."."; ?></b></td><td><b>Thời gian thực hiện</b></td>
				</tr>
				<tr align="left">
				...
				<tr align="left">
					<td align=left colspan=2><b>Tóm tắt hoạt động nghiên cứu và đào tạo sau đại học có liên quan đến đề tài của chủ nhiệm: </b></td>
				</tr>
