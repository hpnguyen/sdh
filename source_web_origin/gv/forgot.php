...
<div id="header-content">
	<div id=header_col1><a href="/gv"><h2>Đại Học Bách Khoa Tp.HCM<br/>Phòng Đào Tạo Sau Đại Học</h2></a></div>
            ...
            <td  colspan="4">
              ...
              <div id="recaptcha_div">
                ...
                if ($_POST["recaptcha_response_field"]) {
                        ...
                        if ($resp->is_valid) {
							$email = $_POST["email"];					
							$str="select password, ho, ten from nhan_su 
							where trim(upper(email))=trim(upper('"
							.str_replace("'", "''",$email)."'))";
							$oci_pa = oci_parse($db_conn,$str);oci_execute($oci_pa);$n=oci_fetch_all($oci_pa, $kt);oci_free_statement($oci_pa);
