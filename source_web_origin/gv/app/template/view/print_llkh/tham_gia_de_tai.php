...
<div class="content-col llkh-first-content">
	<div class="col-title col-title-header" align="center">LÝ LỊCH KHOA HỌC CỦA CÁ NHÂN THAM GIA THỰC HIỆN ĐỀ TÀI, DỰ ÁN SXTN</div>
</div>
...
<div class="content-col the-next-row">
	...
	<div class="col-title second-col">
		...
		&nbsp; &nbsp; &nbsp; <b>Năm được 20phong chức danh KH:</b> <?php echo $cbgd["nam_phong_hoc_ham"] ?>
		<?php } ?>
		<br>
		<b>Học vị:</b>
...
<div class="content-col the-next-row">
	<div class="col-title first-col"><?php echo $z++ . "." ?></div>
	<div class="col-title second-col">
		<b>Cơ quan - nơi làm việc của cá nhân tham gia đề tài, dự án:</b>
...
<div class="content-col the-next-row">
	<div class="col-title first-col">20<?php echo $z++ . "." ?></div>
	<div class="col-title second-col">
