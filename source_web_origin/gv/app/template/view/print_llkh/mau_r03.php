...
<div align="center" class="fontcontent" valign="middle">
	...
	<div class="llkh-first-title" align="center">
		LÝ LỊCH KHOA HỌC
	</div>
	<div align="center">
...
<div class="content-col">
	...
	<div class="col-title second-col"><b>Đề tài/dự án</b></div>
</div>
...
<div class="content-col">
	<div class="col-title first-col"><b><?php echo $z++ . "."; ?></b></div>
	<div class="col-title second-col">
		<b>Hướng dẫn sinh viên, học viên cao học, nghiên cứu sinh</b>
	</div>
</div>
<table autosize="1" width="100%" align="center" cellspacing="0" cellpadding="5" border="1" class="tableData fontcontent bordertable">
	<thead>
...
<div class="content-col">
	<div class="col-title first-col"><b><?php echo $z++ . "."; ?></b></div>
	<div class="col-title second-col">
		<b>Tham gia làm việc tại Trường Đại học/Viện/Trung tâm nghiên cứu theo lời mời</b>
	</div>
</div>
	<table autosize="1" width="100%" align="center" cellspacing="0" cellpadding="5" border="1" class="tableData fontcontent bordertable">
		<thead>
