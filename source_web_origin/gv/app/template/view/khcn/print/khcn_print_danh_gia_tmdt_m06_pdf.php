...
<div style="font-family:Arial, Helvetica, sans-serif">
	<table width="100%"   cellspacing="0" cellpadding="0" class="ui-corner-all shawdow tableData fontcontent" >
      <tr>
		...
		<td valign="top" align="right"><b>BM06/KHCN-08</b></td>
      </tr>
	  <tr>
        <td colspan=2 valign="top" align="center"> 
			<font style="font-size:20px;">
				<b>PHIẾU NHẬN XÉT-ĐÁNH GIÁ THẨM ĐỊNH</b>
				<br>ĐỀ TÀI KHOA HỌC VÀ CÔNG NGHỆ CẤP TRƯỜNG<br>NĂM <?php echo ($detailTmdt["t_nam_dang_ky"] +1); ?>
			</font>
        </td>
      </tr>
</table>
