	  ...
	  <tr>
        <td colspan=2 valign='top'> 
			<div align="center"  style="margin-top:40px; margin-bottom:40px">
				<b><font style="font-size:20px; font-weight:bold;">LÝ LỊCH KHOA HỌC CỦA CHỦ NHIỆM ĐỀ TÀI, DỰ ÁN SXTN</font></b>
			</div>			
        </td>
      </tr>
      <tr>
				...
				<tr>
					<td align=left valign=top width=50% >
						<div style="width:350px; margin-top:20px" align=center>
							...
							Đơn vị đồng ý và sẽ dành thời gian cần thiết để <?php echo "{$cbgd["TITLE"][0]} {$cbgd["HOTENCB"][0]}"; ?> chủ trì thực hiện đề tài, dự án
							<br/>
