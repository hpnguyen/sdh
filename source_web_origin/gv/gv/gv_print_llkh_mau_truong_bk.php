...
{
?>
  <a target="_blank" id="print_ttgv_mau_bk_btn_printpreview" href="front.php/index/llkh/index?hisid=<?php echo $_GET['hisid']  ?>&f=dhbk">&nbsp;In ...</a>
  <a target="_blank" id="pdf_print_ttgv_mau_bk_btn_printpreview" href="front.php/index/llkh/index?hisid=<?php echo $_GET['hisid']  ?>&f=dhbk&pdf=1">&nbsp;File PDF</a>
  <div align="center" style="margin-top:10px; font-family:Arial,Helvetica,sans-serif;" id="chitietttgv_llkh_mau_bk">
<?php
}
?>
	<style>
	  ...
	  <tr>
        <td colspan=2 valign='top'> 
			<div align="center"  style="margin-top:40px; margin-bottom:-10px">
				<b><font style="font-size:20px; font-weight:bold;">LÝ LỊCH KHOA HỌC</font></b><br/>
				<img id=framehinh46_bm_llkh_bk src="" alt="" style="float:right; margin:-60px 0px 0px 5px;" width=160px  >
			</div>
      ...
      <tr>
        <td colspan=2>
			...
			<table width="100%" style="margin-top:-20px" border="0" align="center" cellpadding="5" cellspacing="0" class="fontcontent">
				...
				<tr align="left">
					<td align=left><b><?php $z=1; echo $z++ . "."; ?></b></td><td><b>Các lĩnh vực chuyên môn và hướng nghiên cứu:</b></td>
				</tr>
				<tr align="left">
				...
				<tr align="left">
					<td align=left><b><?php echo $z++ . "."; ?></b></td><td><b>Quá trình nghiên cứu</b></td>
				</tr>
				<tr align="left">
					<td align=left colspan=2>
				...
				<tr align="left">
					<td align=left><b><?php echo $z++ . "."; ?></b></td><td><b>Đã và đang hướng dẫn sinh viên, học viên cao học, nghiên cứu sinh</b></td>
				</tr>
				<tr align="left">
					<td align=left colspan=2>
						<div style="margin-left:0px">
				...
				<tr align="left">
					<td align=left><b><?php $z=1; echo $z++ . "."; ?></b></td><td><b>Sách phục vụ đào tạo đại học, sau đại học</b> <em>(Chuyên khảo, giáo trình, sách tham khảo)</em></td>
				</tr>
				<tr align="left">
				...
				<tr align="left">
					<td align=left><b><?php echo $z++ . "."; ?></b></td><td><b>Bằng phát minh, sáng chế</b></td>
				</tr>
				<tr align="left">
					<td align=left colspan=2>
						<div style="margin-left:0px">
				...
				<tr align="left">
					<td align=left><b><?php $z=1; echo $z++ . "."; ?></b></td><td><b>Tham gia các chương trình trong và ngoài nước, thành viên ban chủ nghiệm các chương trình</b></td>
				</tr>
				<tr align="left">
					<td align=left colspan=2>
						<div style="margin-left:0px">
				...
				<tr align="left">
					<td align=left valign=top><b><?php echo $z++ . "."; ?></b></td><td><b>Tham gia các Hiệp hội khoa học, Ban biên tập các tạp chí Khoa học, Ban tổ chức các Hội nghị về KH&CN, Phản biện tạp chí khoa học, các hội thảo hội nghị quốc tế và trong nước</b></td>
				</tr>
				<tr align="left">
					<td align=left colspan=2>
						<div style="margin-left:0px">
				...
				<tr align="left">
					<td align=left valign=top><b><?php echo $z++ . "."; ?></b></td><td valign=top><b>Tham gia làm việc tại Trường Đại học/Viện/Trung tâm nghiên cứu theo lời mời. Tham gia các hội đồng tư vấn xét duyệt thẩm định đề tài nghiên cứu khoa học cấp nhà nước và trọng điểm</b></td>
				</tr>
				<tr align="left">
					<td align=left colspan=2>
						<div style="margin-left:0px">
	...
	<script type="text/javascript">
	 var day = new Date();
	 var id= day.getTime();
	 document.getElementById("framehinh46_bm_llkh_bk").src='<?php echo $filehinh; ?>' + '?'+id;
	</script>
<?php
if ($a != 'get_llkh')
{
...
$(function(){
 ...
 $( "#print_ttgv_mau_bk_btn_printpreview, #pdf_print_ttgv_mau_bk_btn_printpreview" ).button({ icons: {primary:'ui-icon ui-icon-print'} });
 // $( "#print_ttgv_mau_bk_btn_printpreview" ).click(function(){
	// print_llkh_writeConsole($("#chitietttgv_llkh_mau_bk").html(), 0);
 // });
