...
$oci_n = oci_parse($db_conn,"select value nam_ts from config where name = 'KHOA_TUYEN_SINH_WEB'");
...
?>
	...
	<form id="form_tracuu_DIEM_TS" name="form_tracuu_DIEM_TS" method="post" action="">
	   <table width="100%" border="0" cellspacing="0" cellpadding="5" align=center>
		...
		<tr><td></td><td colspan=3 style="font-family: arial; font-size:10pt; font-weight: bold">THÍ SINH DỰ THI TUYỂN SINH NĂM <?php echo $nam_ts; ?> ĐỢT <?php echo $dot_ts; ?></td></tr>
		<tr>
		  <td align=right style='width:80px'>
			<span class="heading">
			<label for="diem_ts_txtHoTen">Họ & Tên</label>
			</span>
		  </td>
		  ...
		  <td align=right style='width:100px'>
			<span class="heading">
			<label for="diem_ts_txtSBD">hoặc Số báo danh</label>
			</span>
		  </td>
		  <td align=left style='width:150px'>
		...
		<tr>
		  ...
		  <td align=left colspan="3" style='font-size:80%'>
			<a id="diem_ts_btn_xem" >&nbsp;Tra cứu</a>&nbsp;<a id="diem_ts_btn_printpreview" >&nbsp;Xem bản In</a>
		  </td>
	   ...
	   <div id="diem_ts_chitiet" style="margin-top:0px;" align=center></div>
	</form>
<?php
}
else
{
	echo "<div align=center style='font-size:12px; font-weight:bold;'>Chưa có điểm tuyển sinh</div>";
}
?>
</div>
...
function diem_ts_updateDiem(p_sbd, p_hoten, p_ngaysinh)
{
	...
	xreq = $.ajax({
	  type: 'POST', data: DataString, dataType: "html", url: 'hv_tracuu_thongtin_tsdt_process.php',
...
$(function() {
	...
	$("#diem_ts_btn_xem").click(function(){
		...
		{
			bValid = false;
			updateTips('Vui lòng nhập Họ & tên hoặc SBD');
		}
