 ...
 *
 */
class HelperFunctionsUserlogin {
	...
	public function login_check() {
		...
		// var_dump(session_name(),$_SESSION['user_id'], $_SESSION['username'], $_SESSION['login_string']);
		if (isset($_SESSION['user_id'], $_SESSION['username'], $_SESSION['login_string'])) {
			...
			$user_browser = $_SERVER['HTTP_USER_AGENT'];
			$modelUserMembers = new UserMembersModel();
			$checkUserMembers = $modelUserMembers->readByID($user_id);
			
			if ($checkUserMembers != null) {
				// if ($stmt -> num_rows == 1) {
					// If the user exists get variables from result.
					$password = $checkUserMembers['password'];
