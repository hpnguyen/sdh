...
if ($type=='dothoc-kqdonghp')
{
	...
	$sqlstr = "
				SELECT no_dau_ky('$mahv','$dothoc') dau_ky, no_cuoi_ky('$mahv','$dothoc') cuoi_ky, sum(charge) phat_sinh, sum(payment) thanh_toan
				FROM transactions t
	...
	if ($n > 0 ) 
	{
		...
		<div style='margin-top:5px;' align=left>
			Mọi thắc mắc về học phí học viên vui lòng liên hệ điện thoại <b>5262</b> hoặc email: <a href='mailto:nphvu@hcmut.edu.vn'><b>nphvu@hcmut.edu.vn</b></a>
		</div>
